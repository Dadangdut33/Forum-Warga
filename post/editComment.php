...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if ($content == '') {
		...
		if (!$result) {
			...
			header("Location: /post?id=$postID#comment-$id");
		}
	}
}
?>
          ...
          <div class="col-md-12">
            ...
            <form action="" method="post">
              <div class="form-group">
                ...
                <textarea class="form-control" name="content" id="content" rows="3" minlength="10" maxlength="1000"
              ...
              <div class="text-center">
                ...
                <a href="./?id=<?php echo $postID; ?>" class="btn btn-secondary" style="margin-top:5px;">Cancel</a>
              </div>
            </form>
          </div>
        </div>
