      ...
      <div class="row">
        ...
        <div
          ...
          <div class="row align-items-center">
            <h1>FAQ</h1>
            <p>
              <b>How do I create a new topic?</b>
            </p>
            <p>
              A topic can only be created by an Admin. To make a new one please contact/request from the Admin.
            </p>
            <p>
              <b>How do I create a new post?</b>
            </p>
            <p>
              To create a new post, you must be logged in. Once you are logged in, you can click the "New Post" button
              on the top right corner of the page. You will be redirected to a page where you can create a new post.
            </p>
            <p>
              <b>How do I delete a post?</b>
            </p>
            <p>
              To delete a post, you must be logged in. Once you are logged in, you can click the "Delete" button on
              the
